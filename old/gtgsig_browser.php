...
<tr><td><a style="color:#fff;font-size: 10pt;font-family: Work Sans;">Mobile Phone:</a></td><td> <input id="office" class="phonenum" name="office" placeholder="XXX.XXX.XXXX" maxlength="16" /><a>   </a><a style="color:#c19b6e;font-size: 8pt;font-weight: bold;font-family: Work Sans;">*</a></td></tr>
...
<table cellpadding=0 style="font-family:Arial,Helvetica;color:#000;font-size:10pt;vertical-align:top;">
      <tr>
      <td rowspan="3"><div style="border-left:1px solid #000;width:1px;max-width:1px;height:50px;max-height:50px;padding-right:13px;"> </div></td>
      <td>
      <b>
      <span style="text-transform:lowercase !important;white-space:nowrap !important;color:#999999">	
      <?PHP
