...
<tr><td><a style="color:#fff;font-size: 10pt;font-family: Work Sans;">First Name:</a></td><td> <input type="text" id="firstname" name="firstname" placeholder="First Name" required/><a>   </a><a style="color:#E4FC53;font-size: 8pt;font-weight: bold;font-family: Work Sans;">*</a></td></tr>
<tr><td><a style="color:#fff;font-size: 10pt;font-family: Work Sans;">Last Name:</a></td><td> <input type="text" id="lastname" name="lastname" placeholder="Last Name" required/><a>   </a><a style="color:#E4FC53;font-size: 8pt;font-weight: bold;font-family: Work Sans;">*</a></td></tr>
...
<tr><td><a style="color:#fff;font-size: 10pt;font-family: Work Sans;">Mobile Phone:</a></td><td> <input id="office" class="phonenum" name="office" placeholder="XXX.XXX.XXXX" maxlength="16" required/><a>   </a><a style="color:#E4FC53;font-size: 8pt;font-weight: bold;font-family: Work Sans;">*</a></td></tr>
...
<input id="button" type="submit" value="Generate" style="width:100px;padding: 5px 5px 5px !important;font-family:Work Sans;font-size: 13px !important;font-weight: 700;color: #fff;border-radius: 5px;-moz-border-radius: 5px;-webkit-border-radius: 5px;border: 1px solid rgba(0, 51, 73, 1);cursor: pointer;box-shadow: 0 1px 0 rgba(0, 51, 73, 0.5) inset;-moz-box-shadow: 0 1px 0 rgba(0, 51, 73, 0.5) inset;-webkit-box-shadow: 0 1px 0 rgba(0, 51, 73, 0.1) inset;">
<p style="font-family:Work Sans;font-size:7pt;padding-top:10px;margin-bottom:0px;font-style:italic;color:#fff !important">CONFIRM ALL INFO IS CORRECT then move onto STEP 1 below</p>
</div>
</form>
<br>
<div class="size2 active-animatioon">
<div id="copyme">
<table style="vertical-align:top;width:600px;color:#999999">
<tr>
<td width="115" style="background:transparent;width:115px;max-width:115px;border-right: 1px solid #000;">
...
<table cellpadding=0 style="font-family:Arial,Helvetica;color:#999999;font-size:10pt;vertical-align:top;width:450px;">
      <tr>
      <td style="padding-left:13px;">
      <b>
      <span style="!important;white-space:nowrap !important;color:#999999;">
      <?PHP
        ...
        <span style="!important;white-space:nowrap !important;color:#999999 !important;">
         <?PHP
                if (! empty($_GET['title'])){
                echo ' | ';
           ...
           <tr>
     <td style="white-space:nowrap !important;text-decoration:none !important;padding-left:13px;">
       <span style="white-space:nowrap !important;color: #24408e;">
	<font color="#999999">mobile: </font>
        <a href='tel: <?PHP
                if (! empty($_GET["office"])){
                echo $_GET["office"];
                }
                ?>' style="color:#24408e !important;text-decoration:none !important;">
        <?PHP
                if (! empty($_GET['office'])) {
                echo $_GET['office'];
                echo '</a>';
	...
	<?PHP
		if ($_GET['mainline'] == '1')
		{ echo '<font color="#999999"> | main: </font><a style="color:#24408e !important;text-decoration: none !important;" href="tel:248.221.1900">248.221.1900</a>';}
	?>
            </span>
       </tr>
       <tr>
          <td style="font-size:18px !important;padding-left:13px;">
             <span style="white-space:nowrap;color:#999999 !important;">
                <a href="https://allisonworldwide.com" target="_blank" style="text-decoration:none;text-decoration-line: none;display:inline-block;font-weight:100;">
                  <img width="15" height="15" style="height:15px !important;max-height:15px !important;min-height:15px !important; filter: invert(1%) sepia(70%) saturate(2905%) hue-rotate(216deg) brightness(86%) contrast(86%);" src="images/website_20px.png">
                </a>&nbsp;<?PHP echo '//'; ?>&nbsp;
                <a href="https://www.linkedin.com/company/allison-partners" target="_blank" style="text-decoration:none;text-decoration-line: none;display:inline-block;font-weight:100;">
                  <img width="15" height="15" style="height:15px !important;max-height:15px !important;min-height:15px !important; filter: invert(1%) sepia(70%) saturate(2905%) hue-rotate(216deg) brightness(86%) contrast(86%);" src="images/linkedin_20px.png">
                </a>&nbsp;<?PHP echo '//'; ?>&nbsp;
                <a href="https://www.instagram.com/allison_pr/" target="_blank" style="color:#24408e !important;text-decoration:none;text-decoration-line: none;display:inline-block;font-weight:100;">
                  <img width="15" height="15" style="height:15px !important;max-height:15px !important;min-height:15px !important; filter: invert(1%) sepia(70%) saturate(2905%) hue-rotate(216deg) brightness(86%) contrast(86%);" src="images/instagram_20px.png">
                </a></span>
          </td>
    	</tr>
</table>
...
<a style="color:#fff;font-size: 10pt;font-family: Helvetica;">Step 2: </a><a style="color:#E4FC53; font-size: 10pt; font-family: Work Sans; font-weight:700;">Paste into Outlook/OWA</a>
</div>
<br>
</div>
